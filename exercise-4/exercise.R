...
#Set wd
#setwd("~/Desktop/INFO 201/m10-dataframes/exercise-4/")

# Read data into a variable called `grants` using the `read.csv` function
# Make sure *not* to read the strings as factors
grants <- read.csv('~/Desktop/INFO 201/m10-dataframes/exercise-4/data/gates_money.csv', stringsAsFactors = FALSE)
